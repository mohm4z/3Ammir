        ...
        public ProcessPaymentResult ProcessRecurringPayment(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            try
            {
                ...
                var billingPlan = new Plan
                {
                    ...
                    description = $"Telenoc billing plan for the {processPaymentRequest.OrderGuid} order",
                    type = "fixed",
                    ...
                    payment_definitions = new List<PaymentDefinition>
                    {
                        ...
                        {
                             name = "Telenoc payment for the billing plan",
                             type = "REGULAR",
                ...
                {
                    name = $"Telenoc subscription for the {processPaymentRequest.OrderGuid} order",
