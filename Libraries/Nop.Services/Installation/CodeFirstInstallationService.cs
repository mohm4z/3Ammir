...
namespace Nop.Services.Installation
{
    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallCustomersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            ...
            //second user
            var secondUserEmail = "steve_gates@Telenoc.com";
            ...
            //third user
            var thirdUserEmail = "arthur_holmes@Telenoc.com";
            ...
            //fourth user
            var fourthUserEmail = "james_pan@Telenoc.com";
            ...
            //fifth user
            var fifthUserEmail = "brenda_lindgren@Telenoc.com";
            ...
            //sixth user
            var sixthUserEmail = "victoria_victoria@Telenoc.com";
        ...
        protected virtual void InstallOrders()
        {
            ...
            //first order
            var firstCustomer = _customerRepository.Table.First(c => c.Email.Equals("steve_gates@Telenoc.com"));
            ...
            var firstOrderItem3 = new OrderItem()
            {
                ...
                PriceExclTax = 25M,
                OriginalProductCost = decimal.Zero,
                AttributeDescription = "From: Steve Gates &lt;steve_gates@Telenoc.com&gt;<br />For: Brenda Lindgren &lt;brenda_lindgren@Telenoc.com&gt;",
                AttributesXml = "<Attributes><GiftCardInfo><RecipientName>Brenda Lindgren</RecipientName><RecipientEmail>brenda_lindgren@Telenoc.com</RecipientEmail><SenderName>Steve Gates</SenderName><SenderEmail>steve_gates@gmail.com</SenderEmail><Message></Message></GiftCardInfo></Attributes>",
                Quantity = 1,
                DiscountAmountInclTax = decimal.Zero,
                DiscountAmountExclTax = decimal.Zero,
                DownloadCount = 0,
            ...
            var firstOrderGiftcard = new GiftCard
            {
                ...
                RecipientEmail = "brenda_lindgren@Telenoc.com",
                SenderName = "Steve Gates",
                SenderEmail = "steve_gates@Telenoc.com",
            ...
            //second order
            var secondCustomer = _customerRepository.Table.First(c => c.Email.Equals("arthur_holmes@Telenoc.com"));
            ...
            //third order
            var thirdCustomer = _customerRepository.Table.First(c => c.Email.Equals("james_pan@Telenoc.com"));
            ...
            //fourth order
            var fourthCustomer = _customerRepository.Table.First(c => c.Email.Equals("brenda_lindgren@Telenoc.com"));
            ...
            //fifth order
            var fifthCustomer = _customerRepository.Table.First(c => c.Email.Equals("victoria_victoria@Telenoc.com"));
        ...
        protected virtual void InstallSettings(bool installSampleData)
        {
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "http://www.facebook.com/Telenoc",
                TwitterLink = "https://twitter.com/Telenoc",
                YoutubeLink = "http://www.youtube.com/user/Telenoc",
                GooglePlusLink = "https://plus.google.com/+Telenoc",
        ...
        protected virtual void InstallNews(string defaultUserEmail)
        {
            ...
            var news = new List<NewsItem>
            {
                new NewsItem
                {
                    ...
                    Language = defaultLanguage,
                    Title = "About Telenoc",
                    Short = "It's stable and highly usable. From downloads to documentation, www.Telenoc.com offers a comprehensive base of information, resources, and support to the Telenoc community.",
                    Full = "<p>For full feature list go to <a href=\"http://www.Telenoc.com\">Telenoc.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow,
                },
                new NewsItem
                {
                    AllowComments = true,
                    Language = defaultLanguage,
                    Title = "Telenoc new release!",
                    Short = "Telenoc includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! Telenoc is a fully customizable shopping cart",
                    Full = "<p>Telenoc includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow.AddSeconds(1),
                },
                new NewsItem
                {
                    ...
                    Short = "The new Telenoc store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
