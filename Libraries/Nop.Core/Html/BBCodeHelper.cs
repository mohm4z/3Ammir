    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the URL tags: [url=http://www.Telenoc.com]my site[/url]
                // becomes: <a href="http://www.Telenoc.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]http://www.Telenoc.com[/url]
                // becomes: <a href="http://www.Telenoc.com">http://www.Telenoc.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]http://www.Telenoc.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="http://www.Telenoc.com/Content/Images/Image.jpg">
