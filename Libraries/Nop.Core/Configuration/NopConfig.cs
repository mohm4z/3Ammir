namespace Nop.Core.Configuration
{
    ...
    public partial class NopConfig
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether we should support previous Telenoc versions (it can slightly improve performance)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a list of plugins ignored during Telenoc installation
        /// </summary>
