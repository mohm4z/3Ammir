...
namespace Nop.Core.Plugins
{
    ...
    public class PluginManager
    {
        ...
        private static IEnumerable<KeyValuePair<FileInfo, PluginDescriptor>> GetDescriptionFilesAndDescriptors(DirectoryInfo pluginFolder)
        {
            ...
            //it's required: https://www.Telenoc.com/boards/t/17455/load-plugins-based-on-their-displayorder-on-startup.aspx
        ...
        private static IList<string> GetInstalledPluginNames(string filePath)
        {
            ...
            {
                //if not, try to parse the file that was used in previous Telenoc versions
        ...
        private static Assembly PerformFileDeploy(FileInfo plug, ApplicationPartManager applicationPartManager, NopConfig config)
        {
            if (plug.Directory == null || plug.Directory.Parent == null)
                throw new InvalidOperationException("The plugin directory for the " + plug.Name + " file exists in a folder outside of the allowed Telenoc folder hierarchy");
        ...
        private static FileInfo ShadowCopyFile(FileInfo plug, DirectoryInfo shadowCopyPlugFolder)
        {
            ...
            if (shadowCopiedPlug.Exists)
            {
                ...
                else
                {
                    ...
                    //More info: https://www.Telenoc.com/boards/t/11511/access-error-nopplugindiscountrulesbillingcountrydll.aspx?p=4#60838
        ...
        public static PluginDescriptor GetPluginDescriptorFromText(string text)
        {
            ...
            //Telenoc 2.00 didn't have 'SupportedVersions' parameter, so let's set it to "2.00"
